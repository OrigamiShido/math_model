...
% %1
% part_error_original=[0.1038 0.1038];
% part_fee_original=[4 18];
% testfee_part=[2 3];
% errorrate_construct=0.1038;
% partfee_construct=6;
% testfee_product=3;
% changefee=6;
% tearfee=5;
...
% %2
% part_error_original=[0.1985 0.1985];
% part_fee_original=[4 18];
% testfee_part=[2 3];
% errorrate_construct=0.1985;
% partfee_construct=6;
% testfee_product=3;
% changefee=6;
% tearfee=5;
...
% %5
% part_error_original=[0.1038 0.1985];
% part_fee_original=[4 18];
% testfee_part=[8 1];
% errorrate_construct=0.1038;
% partfee_construct=6;
...
%6
part_error_original=[0.0502 0.0502];
part_fee_original=[4 18];
testfee_part=[2 3];
errorrate_construct=0.0502;
partfee_construct=6;
testfee_product=3;
changefee=10;
tearfee=40;
